                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: currentIndex == index
                                    ? lightenColor(ColorPalette.colorPickerList[state.categories[index].color!], 0)
                                    : lightenColor(
                                    ColorPalette.colorPickerList[state.categories[index].color!], .2),
                              ),
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyles.subtitle4.copyWith(
                                    ...
                                    color: currentIndex == index
                                        ? ColorPalette.white
                                        : ColorPalette.colorPickerList[state.categories[index].color!],
                                  ),
                                  textAlign: TextAlign.center,
                                ),
                              ),
